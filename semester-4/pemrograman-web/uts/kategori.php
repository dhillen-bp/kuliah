...
<body>
    ...
    ?>
        <form action="" method="POST">
            <fieldset>
                ...
                <label>ID Kategori <input type="number" name="id_kategori" readonly /></label> <br>
    ...
    function tampil_data($koneksi)
    {
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="kategori.php?aksi=update&id=<?php echo $data['id_kategori']; ?>&kode=<?php echo $data['kode_kategori']; ?>&nama=<?php echo $data['nama_kategori']; ?>">Ubah</a> |
                    <a href="kategori.php?aksi=delete&id=<?php echo $data['id_kategori']; ?>">Hapus</a>
                </td>
            </tr>
        <?php
        }
    ...
    function ubah($koneksi)
    {
        ...
        if (isset($_POST['btn_ubah'])) {
            ...
            if (!empty($kd_kategori) && !empty($nm_kategori)) {
                ...
                $sql_update = "UPDATE kategori_179 SET " . $perubahan . " WHERE id_kategori = $id";
        ...
        ?>
            ...
            <form action="" method="POST">
                <fieldset>
                    ...
                    <label>ID Kategori <input type="number" name="id_kategori" value="<?php echo $_GET['id'] ?>" readonly /></label> <br>
                    ...
                    <br>
                    <label>
                        <input type="submit" name="btn_ubah" value="Simpan Perubahan" /> atau <a href="kategori.php?aksi=delete&id=<?php echo $_GET['id'] ?>"> (x) Hapus data ini</a>!
                    </label>
                    <br>
                    <p><?php echo isset($pesan) ? $pesan : "" ?></p>
    ...
    function hapus($koneksi)
    {
        if (isset($_GET['id']) && isset($_GET['aksi'])) {
            $id = $_GET['id'];
            $sql_hapus = "DELETE FROM kategori_179 WHERE id_kategori =" . $id;
